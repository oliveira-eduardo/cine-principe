...
public class Filme {
    ...
    public Filme(int id, String nome, String duracao, String sinopse, float valor, String nomeImagem) {
        this.id = id;
        this.nome = nome;
    ...
    public Filme(String nome, String duracao, String sinopse, float valor, String nomeImagem) {
        this.nome = nome;
        this.duracao = duracao;
        this.sinopse = sinopse;
        this.valor = valor;
